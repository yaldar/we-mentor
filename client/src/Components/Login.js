...
const Login = props => {
  ...
  return (
    <div className='login'>
      ...
      <p className="div1">What is the need? Mentoring focused for the tech sector. Who is it for? Women in tech.</p> <a className="div2" href='http://localhost:4000/login'>Sign in with Linkedin</a>
      </header>
      ...
      <article className='media'>
        <Media>
          ...
          <section className='media__text'>
            <Media body>
              <Media heading>Media heading</Media>A really nice blurry pic of two power women in tech. Meet women in tech and find a mentor that guides you through your career. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ac semper libero. Nam iaculis lobortis lacinia. Mauris eleifend, sem vel fringilla porta, orci odio vulputate sapien, tincidunt lobortis dui justo ut purus. Sed vel vestibulum urna, vel fermentum urna. Suspendisse lobortis fermentum orci, sit amet lacinia nibh accumsan sit amet.
            </Media>
          </section>
        </Media>
      </article>
